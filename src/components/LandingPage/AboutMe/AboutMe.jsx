  ...
  return (
    <div className="about-me-parent-wrapper">
      <div className="about-me-wrapper" ref={ref}>
        ...
        <div className="about-me-contact-wrapper">
          <div className="about-me-content">
            ...
            <Typography>
              ...
              Azure allows me to design and implement scalable and efficient
              systems. Known for my attention to detail and commitment to
              excellence, I consistently deliver high-quality solutions within
              tight deadlines. I am a proactive problem-solver, always eager to
              embrace new challenges and stay ahead in the ever-evolving tech
              landscape.
            </Typography>
          </div>
          <div className="contact-resume-wrapper">
            ...
            >
              <Button variant="contained" className="download-resume-btn">
                <DownloadIcon />
                <div className="download-btn-text">Resume</div>
              </Button>
            </a>
          </div>
        </div>
